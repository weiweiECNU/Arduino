/*! \file WaspBLE.h
    \briefLibrary for managing the Bluetooth low energy BLE112 with the multiprotocol shield
 ...
 */
#ifndef MySignals_BLE_h
#define MySignals_BLE_h
...
///FIX: avoid using waspmote libraries
...
// Default scanning time in milliseconds when not specified.
#define DEFAULT_SCAN_TIME						30000 
...
#define SCAN_EEPROM_START_ADDRESS			100
#define SCAN_EEPROM_LIMIT_ADDRESS			900		
#define SCAN_END							0xF0		


 
//Handle list
#define handle_serial_number 14
#define handle_1_0 30
#define handle_1_1 34
#define handle_1_2 38
#define handle_1_3 42
#define handle_1_4 46

#define handle_2_1 55

#define handle_3_0 64
#define handle_3_1 68
#define handle_3_2 72
#define handle_3_3 76
#define handle_3_4 80
#define handle_3_5 84
#define handle_3_6 88
#define handle_3_7 92
#define handle_3_8 96
#define handle_3_9 100
#define handle_3_10 104
#define handle_3_11 108
#define handle_3_12 112
#define handle_3_13 116
#define handle_3_14 120
#define handle_3_15 124
#define handle_3_16 128
...
class BLEClass
{
	...
	*/
	 ...
	 */
	uint16_t sendCommand(uint8_t * customCommand);
	...
	uint8_t checkConnection(uint8_t connection_handle);
	
	uint16_t setMode(bool _mode);
	
	void initialize_BLE_values();
	
	bool ble_mode_flag;
	bool app_connected_flag;
    bool bonded_and_connected_flag;
    bool bond_mode_and_mitm;
    bool bonding_fail;
    bool bonding_correct;
